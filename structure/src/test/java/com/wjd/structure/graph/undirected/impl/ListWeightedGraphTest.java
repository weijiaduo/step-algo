...
class ListWeightedGraphTest {

    @Test
    void vs() {
        WeightedGraph wg = new ListWeightedGraph(2);
        assertEquals(2, wg.vs());
        wg = new ListWeightedGraph(19);
        assertEquals(19, wg.vs());
        wg = new ListWeightedGraph(25);
        assertEquals(25, wg.vs());
        wg = new ListWeightedGraph(72);
        assertEquals(72, wg.vs());
    }

    @Test
    void es() {
        WeightedGraph wg = new ListWeightedGraph(12);
