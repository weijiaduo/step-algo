...
class ListWeightedDigraphTest {

    @Test
    void vs() {
        WeightedDigraph wdg = new ListWeightedDigraph(2);
        assertEquals(2, wdg.vs());
        wdg = new ListWeightedDigraph(19);
        assertEquals(19, wdg.vs());
        wdg = new ListWeightedDigraph(25);
        assertEquals(25, wdg.vs());
        wdg = new ListWeightedDigraph(72);
        assertEquals(72, wdg.vs());
    }

    @Test
    void es() {
        WeightedDigraph wdg = new ListWeightedDigraph(12);
